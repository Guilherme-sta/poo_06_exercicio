...
class App{
    ...
    private executarOpcao(opcao: string): void {
        switch (opcao) {
            case "01":
                this.inserirConta();
                break;
    ...
    private inserirConta(): void {
        ...
        let conta: Conta = new Conta(numero, saldo); // Cliente será associado depois
    ...
    private totalizarSaldoCliente(): void {
        ...
        console.log("Total aplicado pelo cliente: " + total);
    }
    ...
    private realizarOrdemBancaria(): void {
        ...
        let numeros: string[] = this.input('Digite os números das contas separadas por espaço: ').split(" ");
    ...
    private transferirTitularidade(): void {
    ...
    private listarContasSemClientes(): void {
